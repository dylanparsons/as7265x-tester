#!/usr/bin/env python3
"""
AS7265x Spectral Sensor Test GUI v2.0
Professional test application for SparkFun AS7265x Spectral Triad sensors
...
Background:
Developed as an open source tool to help the maker/electronics community 
test AS7265x sensors. Currently being evaluated for production use.
"""
